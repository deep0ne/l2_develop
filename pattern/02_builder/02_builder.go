/*
Паттерн строителя относится к порождающим паттернам. Он определяет процесс поэтапного простроения сложного продукта.
Он позволяет создавать объекты шаг за шагом, что упрощает понимание и поддержку кода, но требует дополнительных классов и интерфейсов.
Реальный пример использования такого паттерна - это создание персонажа в игре с свойствами и способностями.
*/
